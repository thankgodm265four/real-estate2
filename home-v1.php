        ...
        <nav id="mainNav" class="fixed top-0 left-0 right-0 flex items-center justify-between px-4 md:px-8 lg:px-24 py-4 md:py-6 z-50 transition-all duration-300">
            ...
            <div class="hidden lg:flex absolute left-1/2 transform -translate-x-1/2">
                <ul class="flex items-center gap-1 bg-white/20 backdrop-blur-md border border-white/20 rounded-full p-1.5">
                    ...
                    <li>
                        <a href="#" class="text-white px-5 py-2 rounded-full hover:bg-white/10 transition-all duration-300 font-medium text-sm">
                            Projects
                        </a>
                    </li>
                    <li>
                    ...
                    <li class="relative pages-dropdown">
                        ...
                        <div class="dropdown-menu absolute top-full mt-2 left-0 bg-white/95 backdrop-blur-md border border-white/20 rounded-2xl shadow-xl overflow-hidden opacity-0 invisible transition-all duration-300 min-w-[200px]">
                            <a href="#" class="block px-6 py-3 text-gray-800 hover:bg-gray-100 transition text-sm">Home V1</a>
                            <a href="#" class="block px-6 py-3 text-gray-800 hover:bg-gray-100 transition text-sm">Blog V1</a>
                            <a href="#" class="block px-6 py-3 text-gray-800 hover:bg-gray-100 transition text-sm">Contact V1</a>
                            <a href="#" class="block px-6 py-3 text-gray-800 hover:bg-gray-100 transition text-sm">Services</a>
                        </div>
                    </li>
                </ul>
            </div>
            ...
            <div class="flex items-center gap-3 md:gap-4 relative z-50">
                ...
                <a href="#" class="hidden md:inline-block bg-white text-gray-900 px-4 md:px-5 py-2 rounded-md text-sm font-medium hover:bg-gray-100 transition">
                    Buy template
                </a>
        ...
        >
            ...
            <div class="relative flex flex-col">
                ...
                <nav class="flex flex-col gap-4 md:gap-6 px-6 md:px-8 py-4 pb-6">
                    <a href="#" class="text-lg md:text-xl font-normal text-gray-900 hover:translate-x-2 transition-transform duration-300">
                        Home
                    </a>
                    ...
                    <div class="mobile-pages-dropdown">
                        ...
                        <div class="mobile-dropdown-content max-h-0 overflow-hidden transition-all duration-300">
                            <div class="pl-6 pt-3 space-y-3">
                                <a href="#" class="block text-base text-gray-600 hover:text-gray-900 transition-colors duration-300">Home V1</a>
                                <a href="#" class="block text-base text-gray-600 hover:text-gray-900 transition-colors duration-300">Blog V1</a>
                                <a href="#" class="block text-base text-gray-600 hover:text-gray-900 transition-colors duration-300">Contact V1</a>
                                <a href="#" class="block text-base text-gray-600 hover:text-gray-900 transition-colors duration-300">Testimonials</a>
                                <a href="#" class="block text-base text-gray-600 hover:text-gray-900 transition-colors duration-300">Core Team</a>
                                <a href="#" class="block text-base text-gray-600 hover:text-gray-900 transition-colors duration-300">FAQs</a>
                            </div>
                        </div>
                    </div>
                </nav>
